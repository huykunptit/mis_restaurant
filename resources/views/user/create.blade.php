...
<div class="p-6 lg:p-10 bg-gray-50 min-h-screen">
    ...
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Thêm người dùng mới</h1>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-2xl">
        <p class="text-gray-600 mb-6">Vui lòng điền thông tin vào form bên dưới để tạo tài khoản người dùng mới</p>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach ($roles as $role)
                            <option value="{{ $role->id }}" {{ old('role') == $role->id ? 'selected' : '' }} class="capitalize">{{ $role->name }}</option>
                        @endforeach
                    </select>
                    @error('role')
