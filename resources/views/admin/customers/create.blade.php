...
<div class="container-fluid py-4 bg-light min-vh-100">
    ...
    {{-- Header --}}
    <div class="mb-4">
        <h1 class="h2 fw-bold text-dark mb-2">Thêm khách hàng mới</h1>
    ...
    <div class="card shadow-sm mx-auto" style="max-width: 600px;">
        <div class="card-body">
            <p class="text-muted mb-4">Vui lòng điền thông tin vào form bên dưới để tạo tài khoản khách hàng mới</p>
