...
<div class="container-fluid py-4 bg-light min-vh-100">
    ...
    {{-- Header --}}
    <div class="mb-4">
        <h1 class="h2 fw-bold text-dark mb-2">Sửa thông tin nhân viên</h1>
    ...
    <div class="card shadow-sm mx-auto" style="max-width: 600px;">
        <div class="card-body">
            <p class="text-muted mb-4">Cập nhật thông tin nhân viên</p>
                ...
                <div class="mb-3">
                    ...
                    >
                        ...
                        @foreach ($shifts as $shift)
                            <option value="{{ $shift->id }}" {{ old('shift_id', $staff->shift_id) == $shift->id ? 'selected' : '' }}>
