...
<div class="p-10">
    ...
    {{-- Page Name --}}
    <p class="text-3xl font-bold">Thêm bàn mới</p>
    ...
    {{-- Form Description --}}
    <p class="text-gray-500 mb-10">Vui lòng điền thông tin bàn</p>
    ...
    <form action="{{ route('tables.store') }}" method="POST">
        ...
        <div class="lg:w-1/2 grid grid-cols-2 gap-x-5 gap-y-8 mb-20">
            ...
            <div class="col-span-1">
                ...
                <input type="text" name="table_number" value="{{ old('table_number') }}" maxlength="16" class="w-full mt-3 p-2 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg" required>
            ...
            <div class="col-span-1">
                ...
                <input type="number" name="seats" value="{{ old('seats') }}" min="1" class="w-full mt-3 p-2 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg" required>
            ...
            <div class="col-span-2 grid grid-cols-2 gap-x-5">
                ...
                <div class="col-span-1 mt-3">
                    <select name="status" id="status" class="w-full p-1 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg capitalize" required>
                        <option value="available" {{ old('status') == 'available' ? 'selected' : '' }} class="capitalize">Trống</option>
                        <option value="reserved" {{ old('status') == 'reserved' ? 'selected' : '' }} class="capitalize">Đã đặt</option>
                        <option value="occupied" {{ old('status') == 'occupied' ? 'selected' : '' }} class="capitalize">Đang sử dụng</option>
                    </select>
                </div>
